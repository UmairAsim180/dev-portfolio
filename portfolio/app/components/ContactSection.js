...
export default function ContactSection() {
    ...
    return (
        <motion.div
            ...
            className="p-4"
        >
            <div className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl bg-color6 [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                <div>
                    <h1 className="text-color1 text-3xl font-semibold">Let's Talk</h1>
                ...
                <form className="space-y-4">
                    ...
                    <input onChange={handleChange} type='text' name="subject" placeholder='Subject'
                        className="w-full text-slate-900 rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-0 focus:border-blue-500" />
                    <textarea onChange={handleChange} placeholder='Message' name="message" rows="6"
